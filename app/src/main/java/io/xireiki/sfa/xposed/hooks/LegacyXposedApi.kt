...
object LegacyXposedApi : XposedApi {
    ...
    private fun XC_MethodHook.MethodHookParam.toHookParam(): io.xireiki.sfa.xposed.hooks.MethodHookParam {
    ...
    private fun copyBack(
        hookParam: io.xireiki.sfa.xposed.hooks.MethodHookParam,
