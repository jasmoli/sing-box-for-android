package io.xireiki.sfa.compose.navigation
...
import io.xireiki.sfa.compose.screen.configuration.NewProfileScreen
import io.xireiki.sfa.compose.screen.connections.ConnectionDetailsRoute
import io.xireiki.sfa.compose.screen.connections.ConnectionsPage
import io.xireiki.sfa.compose.screen.connections.ConnectionsViewModel
import io.xireiki.sfa.compose.screen.dashboard.DashboardScreen
import io.xireiki.sfa.compose.screen.dashboard.DashboardViewModel
import io.xireiki.sfa.compose.screen.dashboard.GroupsCard
import io.xireiki.sfa.compose.screen.dashboard.groups.GroupsViewModel
import io.xireiki.sfa.compose.screen.log.HookLogScreen
import io.xireiki.sfa.compose.screen.log.LogScreen
import io.xireiki.sfa.compose.screen.log.LogViewModel
import io.xireiki.sfa.compose.screen.privilegesettings.PrivilegeSettingsManageScreen
import io.xireiki.sfa.compose.screen.profile.EditProfileRoute
import io.xireiki.sfa.compose.screen.profileoverride.PerAppProxyScreen
...
import io.xireiki.sfa.compose.screen.settings.ServiceSettingsScreen
import io.xireiki.sfa.compose.screen.settings.SettingsScreen
import io.xireiki.sfa.compose.screen.settings.TailscaleFontPickerScreen
import io.xireiki.sfa.compose.screen.settings.TailscaleGhosttyConfigEditorScreen
import io.xireiki.sfa.compose.screen.settings.TailscaleTerminalConfigScreen
import io.xireiki.sfa.compose.screen.settings.TailscaleThemePickerScreen
import io.xireiki.sfa.compose.screen.tools.CrashReportDetailScreen
import io.xireiki.sfa.compose.screen.tools.CrashReportFileContentScreen
import io.xireiki.sfa.compose.screen.tools.CrashReportListScreen
import io.xireiki.sfa.compose.screen.tools.CrashReportMetadataScreen
import io.xireiki.sfa.compose.screen.tools.NetworkQualityScreen
import io.xireiki.sfa.compose.screen.tools.OOMReportDetailScreen
import io.xireiki.sfa.compose.screen.tools.OOMReportFileContentScreen
import io.xireiki.sfa.compose.screen.tools.OOMReportListScreen
import io.xireiki.sfa.compose.screen.tools.OOMReportMetadataScreen
import io.xireiki.sfa.compose.screen.tools.OpenConnectEndpointScreen
import io.xireiki.sfa.compose.screen.tools.OpenConnectStatusViewModel
import io.xireiki.sfa.compose.screen.tools.OpenVPNEndpointScreen
import io.xireiki.sfa.compose.screen.tools.OpenVPNStatusViewModel
import io.xireiki.sfa.compose.screen.tools.OutboundPickerScreen
import io.xireiki.sfa.compose.screen.tools.PowerReportDetailScreen
import io.xireiki.sfa.compose.screen.tools.PowerReportFileContentScreen
import io.xireiki.sfa.compose.screen.tools.PowerReportListScreen
import io.xireiki.sfa.compose.screen.tools.PowerReportMetadataScreen
import io.xireiki.sfa.compose.screen.tools.STUNTestScreen
import io.xireiki.sfa.compose.screen.tools.TaildropInboxScreen
import io.xireiki.sfa.compose.screen.tools.TaildropViewModel
import io.xireiki.sfa.compose.screen.tools.TailscaleEndpointScreen
import io.xireiki.sfa.compose.screen.tools.TailscaleExitNodePickerScreen
import io.xireiki.sfa.compose.screen.tools.TailscalePeerScreen
import io.xireiki.sfa.compose.screen.tools.TailscaleSSHPromptScreen
import io.xireiki.sfa.compose.screen.tools.TailscaleSSHSharedViewModel
import io.xireiki.sfa.compose.screen.tools.TailscaleSSHTerminalScreen
import io.xireiki.sfa.compose.screen.tools.TailscaleStatusViewModel
import io.xireiki.sfa.compose.screen.tools.ToolsScreen
import io.xireiki.sfa.compose.screen.usbip.USBIPDeviceDetailScreen
import io.xireiki.sfa.compose.screen.usbip.USBIPServerScreen
import io.xireiki.sfa.compose.screen.usbip.USBIPStatusViewModel
