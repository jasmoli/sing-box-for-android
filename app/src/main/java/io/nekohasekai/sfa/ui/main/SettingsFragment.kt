...
class SettingsFragment : Fragment() {
    ...
    private fun onCreate() {
        ...
        binding.checkUpdateEnabled.addTextChangedListener {
            lifecycleScope.launch(Dispatchers.IO) {
                val newValue = EnabledType.getType(it, this).boolValue
    ...
    private suspend fun reloadSettings() {
        ...
        withContext(Dispatchers.Main) {
            ...
            binding.checkUpdateEnabled.text = getString(EnabledType.from(checkUpdateEnabled).keyNameId)
            binding.checkUpdateEnabled.setSimpleItems(R.array.enabled)
            binding.disableMemoryLimit.text = getString(EnabledType.from(!Settings.disableMemoryLimit).keyNameId)
            ...
            binding.dynamicNotificationEnabled.text = getString(EnabledType.from(dynamicNotification).keyNameId)
